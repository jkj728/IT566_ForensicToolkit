...
## Introduction
This repository consists of a digital database of tools and guides used, written and discovered over the course of my semester in my IT566 - Digital Forensics class. As per the project requirement, this database is a public repository and is also contained entirely within this readme. To make this forensic toolkit easily readable, it is separated only into this introduction and a 'Tools' section below. Each tool has its own subsection and table that contains information about said tool.
Each tools table will contain the following information for each tool: <ul><li>Description</li><li>Personal Review</li><li>Personal Notes on Usage</li><li>Source</li></ul>
